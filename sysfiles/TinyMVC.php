...
set_include_path(get_include_path()
  ...
  . PATH_SEPARATOR . TMVC_MYAPPDIR . 'controllers/web' . DS
  . PATH_SEPARATOR . TMVC_MYAPPDIR . 'controllers/admin' . DS
  ...
  . PATH_SEPARATOR . TMVC_MYAPPDIR . 'views/web' . DS
  . PATH_SEPARATOR . TMVC_MYAPPDIR . 'views/admin' . DS
